...
namespace UtauPluginNoteTest
{
    ...
    public class UtauPluginNoteTest
    {
        ...
        {
            note.InitLyric("い");
            Assert.IsTrue(note.GetLyric() == "い");
            Assert.IsFalse(note.LyricIsChanged());
            note.SetLyric("あ");
            Assert.IsTrue(note.GetLyric() == "あ");
        ...
        public void SetAtFileName()
        {
            ...
            Assert.IsTrue(note.GetAtFileName() == "い");
            Assert.IsFalse(note.AtFileNameIsChanged());
            note.SetAtFileName("あ");
            Assert.IsTrue(note.GetAtFileName() == "あ");
        ...
        {
            note.InitAtAlias("い");
            Assert.IsTrue(note.GetAtAlias() == "い");
            Assert.IsFalse(note.AtAliasIsChanged());
            note.SetAtAlias("あ");
            Assert.IsTrue(note.GetAtAlias() == "あ");
        ...
        {
            note.InitFlags("い");
            Assert.IsTrue(note.GetFlags() == "い");
            Assert.IsFalse(note.FlagsIsChanged());
            note.SetFlags("あ");
            Assert.IsTrue(note.GetFlags() == "あ");
        ...
        {
            note.InitLabel("い");
            Assert.IsTrue(note.GetLabel() == "い");
            Assert.IsFalse(note.LabelIsChanged());
            note.SetLabel("あ");
            Assert.IsTrue(note.GetLabel() == "あ");
        ...
        {
            note.InitRegion("い");
            Assert.IsTrue(note.GetRegion() == "い");
            Assert.IsFalse(note.RegionIsChanged());
            note.SetRegion("あ");
            Assert.IsTrue(note.GetRegion() == "あ");
        ...
        public void SetRegionEnd()
        {
            ...
            Assert.IsTrue(note.GetRegionEnd() == "い");
            Assert.IsFalse(note.RegionEndIsChanged());
            note.SetRegionEnd("あ");
            Assert.IsTrue(note.GetRegionEnd() == "あ");
